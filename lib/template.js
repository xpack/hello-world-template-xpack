...
const propertiesDefinitions = {
  ...
  buildGenerator: {
    ...
    items: {
      ...
      autotools: 'Autotools configure & GNU make'
    },
    default: 'cmake'
  }
}
...
class XpmInitTemplate {
  ...
  async generate (liquidMap, isInteractive) {
    ...
    if (liquidMap.buildGenerator === 'cmake') {
      ...
      await this.render('meta/make-template/src/folder-liquid.mk',
        'meta/make-template/src/folder.mk',
        liquidMap
      )
      await this.render('meta/make-template/makefile-liquid',
        'meta/make-template/makefile',
        liquidMap
      )
    }
